...
```{r}
boxplot(imdb_score ~ title_year, data=training_data, col='red')
title("IMDb score vs year")
```

最关心变量：gross, budget, imdb_score，使用直方图看一看他们的分布：
...
lets's interpretate of the coefficients.
