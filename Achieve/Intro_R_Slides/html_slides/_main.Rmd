...
<!--chapter:end:04-basicGraphs.Rmd-->
...
<!--chapter:end:05-ggplot2-1.Rmd-->

# 数据可视化第三课：案例

## 泰坦尼克号生还者分析

<!--chapter:end:06-ggplot2-2.Rmd-->
...
<!--chapter:end:07-linearRegression1.Rmd-->
...
<!--chapter:end:08-linearRegression2.Rmd-->
...
<!--chapter:end:09-linearRegression3.Rmd-->

# dplyr包

<!--chapter:end:10-dataManagement.Rmd-->
